	...
	<div id="wrapper" class="clearfix">
			...
			<div class="container">
				<div class="row h-100 align-items-center justify-content-between">
					...
					<div class="col-lg-8 col-md-6">
						<img src="/resources/demos/nonprofit/images/about/1.png" alt="Image" class="full-width-img">
					</div>
				</div>
			</div>
		...
		<section id="content">
			<div class="content-wrap py-0 overflow-visible">
				...
				<div class="container">
					...
					<div class="slider-feature">
						<div class="row gutter-10 justify-content-center">
							<div class="col-md-3">
								<div class="card center border-start-0 border-end-0 border-top-0 border-bottom border-bottom shadow py-3 rounded-0 fw-semibold text-uppercase ls1 h-translate-y-sm all-ts">
									<div class="card-body">
				...
				<div class="section mt-3" style="background: url('/resources/demos/nonprofit/images/others/section-bg.jpg') no-repeat center center / cover; padding: 80px 0;">
					<div class="container clearfix">
				...
				<div class="section bg-transparent">
					<div class="container clearfix">
						<div class="row justify-content-center">
							...
							<h5 class="fw-normal text-black-50 mb-0">If you want to work with for nonprofit? <a href="#"><u>Send your Details</u></a>.</h5>
						</div>
					</div>
				</div>
