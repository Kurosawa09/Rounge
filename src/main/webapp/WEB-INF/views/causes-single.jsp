...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-dark page-title-parallax page-title-center" style="background: linear-gradient(to bottom, rgba(6, 54, 57,.9), rgba(6, 54, 57,.9)), url('/resources/demos/nonprofit/images/cause/grid/1.jpg') no-repeat center center; background-size: cover; padding: 120px 0;">
							...
							<div class="single-post mb-0">
								...
								<div class="entry clearfix">
									...
									<div class="entry-image mb-0">
										<a href="#"><img src="/resources/demos/nonprofit/images/cause/grid/1.jpg" alt="Blog Single"></a>
									</div><!-- .entry-image end -->
												...
												<li data-percent="81">
													<div class="progress">
														<div class="progress-percent">
															<div class="counter counter-inherit counter-instant"><span data-from="0" data-to="81" data-refresh-interval="30" data-speed="1100"></span>%</div>
														</div>
													</div>
												</li>
											</ul>
									...
									<div class="entry-content mt-0">
										...
										<p><img src="/resources/demos/nonprofit/images/cause/grid/3.jpg" alt="Image" class="alignright" width="360">Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras mattis consectetur purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus.</p>
								...
								<div id="comments" class="clearfix border-0">
									...
									<div id="respond">
										...
										<form class="row" action="#" method="post" id="commentform">
											...
											<div class="col-12 form-group">
												<button name="submit" type="submit" id="submit-button" tabindex="5" value="Submit" class="button button-rounded button-border nott ls0 fw-normal border-color m-0">Submit Comment</button>
											</div>
										</form>
												...
												<div class="posts-sm row col-mb-30" id="popular-post-list-sidebar">
														...
														<div class="grid-inner row g-0">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="/resources/images/magazine/small/3.jpg" alt="Image"></a>
																</div>
															</div>
															<div class="col ps-3">
													...
													<div class="entry col-12">
														<div class="grid-inner row g-0">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="/resources/images/magazine/small/2.jpg" alt="Image"></a>
																</div>
															</div>
															<div class="col ps-3">
																<div class="entry-title">
													...
													<div class="entry col-12">
														<div class="grid-inner row g-0">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="/resources/images/magazine/small/1.jpg" alt="Image"></a>
																</div>
															</div>
															<div class="col ps-3">
																<div class="entry-title">
												...
												<div class="posts-sm row col-mb-30" id="recent-comments-list-sidebar">
													<div class="entry col-12">
														<div class="grid-inner row g-0">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="/resources/images/icons/avatar.jpg" alt="User Avatar"></a>
																</div>
															</div>
															<div class="col ps-3">
			...
			<div class="container">
				...
				<div class="footer-widgets-wrap dark clearfix" style="background: radial-gradient(rgba(0,45,64,.5), rgba(0,45,64,.1), rgba(0,45,64,.5)), url('/resources/demos/nonprofit/images/others/footer.jpg') repeat center center / cover;  padding: 150px 0">
					<div class="mx-auto center" style="max-width: 700px;">
						...
						<a href="#" class="button button-rounded button-xlarge button-white bg-white button-light text-dark shadow nott ls0 ms-0 mt-5">Donate Now</a>
					</div>
				</div>
