...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title" class="page-title-dark page-title-parallax page-title-center" style="background: linear-gradient(to bottom, rgba(6, 54, 57,.9), rgba(6, 54, 57,.9)), url('/resources/demos/nonprofit/images/cause/page-title.jpg') no-repeat center center; background-size: cover; padding: 140px 0;">
			...
			<div class="content-wrap overflow-visible">
				...
				<div class="container">
					<div class="row col-mb-30">
						...
						<div class="col-12">
							<div class="donor-img d-flex align-items-center rounded mx-auto shadow-sm w-100" style="height: 500px; background: url('/resources/demos/nonprofit/images/others/3.jpg') no-repeat center center / cover"></div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.html">
									<img src="/resources/demos/nonprofit/images/cause/grid/1.jpg" alt="Image" class="card-img-top">
								</a>
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.html">
									<img src="/resources/demos/nonprofit/images/cause/grid/2.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.html">
									<img src="/resources/demos/nonprofit/images/cause/grid/3.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.html">
									<img src="/resources/demos/nonprofit/images/cause/grid/4.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.html">
									<img src="/resources/demos/nonprofit/images/cause/grid/5.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls1 mb-2 d-block">Education</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.html">Donation for Children</a></h3>
									<ul class="skills mb-3">
										<li data-percent="57">
											<div class="progress">
												<div class="progress-percent">
						...
						<div class="col-lg-4 col-md-6">
							<div class="charity-card h-shadow shadow-ts card rounded-5">
								<a href="demo-nonprofit-causes-single.html">
									<img src="/resources/demos/nonprofit/images/cause/grid/6.jpg" alt="Image" class="card-img-top">
								</a>
								<div class="px-4 py-3 charity-card-title">
									<small class="text-uppercase fw-normal ls1 mb-2 d-block">Cloths</small>
									<h3 class="mb-3"><a href="demo-nonprofit-causes-single.html">Cloths Donate for All</a></h3>
									<ul class="skills mb-3">
										<li data-percent="87">
											<div class="progress">
												<div class="progress-percent">
													<div class="counter counter-inherit">
														$<span data-from="0" data-comma="true" data-to="31500" data-refresh-interval="10" data-speed="1100"></span> Donated of $110,000
													</div>
												</div>
											</div>
										</li>
